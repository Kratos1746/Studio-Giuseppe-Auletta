      ...
      service.getDetails(
        ...
        (place: any, status: any) => {
          if (status === window.google.maps.places.PlacesServiceStatus.OK && place?.reviews) {
            setReviews(place.reviews.slice(0, 10))
          }
        }
      )
    }
              ...
              {reviews.map((review, i) => (
                <div key={i} className="px-3">
                  <div className="flex flex-col  text-white min-h-[300px]">             
                    ...
                    <div className="mt-4">
                    <a
                      href="https://www.google.com/maps/place/Avv.+Giuseppe+Auletta+-+Studio+Legale/@37.5067681,15.0500534,475m/data=!3m1!1e3!4m8!3m7!1s0x1313fdca4090996d:0x682825f9a9b08242!8m2!3d37.5067233!4d15.0495955!9m1!1b1!16s%2Fg%2F11s7c78c2k?entry=ttu&g_ep=EgoyMDI1MDQxMy4wIKXMDSoASAFQAw%3D%3D"
                      target="_blank"
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 533.5 544.3" width="20" height="20">
                            <path fill="#4285F4" d="M533.5 278.4c0-17.4-1.6-34-4.7-50.2H272v95h146.9c-6.4 34.3-25 63.4-53.2 82.8v68h85.9c50.2-46.2 81.9-114.3 81.9-195.6z"/>
                            <path fill="#34A853" d="M272 544.3c72.4 0 133.1-23.9 177.5-64.9l-85.9-68c-23.8 16-54.2 25.5-91.6 25.5-70.4 0-130.1-47.6-151.4-111.6h-90v70.2C89.3 485.5 173.7 544.3 272 544.3z"/>
                            <path fill="#FBBC05" d="M120.6 325.3c-10.6-31.5-10.6-65.4 0-96.9v-70.2h-90c-39 78-39 159.2 0 237.2l90-70.1z"/>
                            <path fill="#EA4335" d="M272 107.7c39.3 0 74.6 13.6 102.3 40.2l76.5-76.5C405.1 24.8 344.4 0 272 0 173.7 0 89.3 58.8 30.6 158.2l90 70.2C141.9 155.3 201.6 107.7 272 107.7z"/>
                          </svg>
